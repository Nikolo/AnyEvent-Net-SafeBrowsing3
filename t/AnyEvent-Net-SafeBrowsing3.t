...
is( unpack( 'V', $gsb->prefix('abc')), unpack( 'V', pack( 'H*', 'ba7816bf')), 'prefix "abc" is OK');

is( unpack( 'V', $gsb->prefix('abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq')), unpack( 'V', pack('H*', '248d6a61')), 'prefix  is OK');
is( unpack( 'V', $gsb->prefix('a' x 1000000)), unpack( 'V', pack( 'H*', 'cdc76e5c')), 'prefix "a"  is OK');
