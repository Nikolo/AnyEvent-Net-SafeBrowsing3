package AnyEvent::Net::SafeBrowsing3::Storage;
...
See L<AnyEvent::Net::SafeBrowsing3::Tarantool> or L<AnyEvent::Net::SafeBrowsing3::Empty> for an example of storing and managing the Safe Browsing database.
